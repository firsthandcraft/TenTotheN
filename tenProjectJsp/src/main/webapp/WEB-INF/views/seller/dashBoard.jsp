...
<!-- 개별 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/dashBoardSeller.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/dashBoardSeller.js"></script>
</head>
<body>
	<header id="adminHeader"><c:import url="../common/headerSeller.jsp"></c:import></header>
    <main>
